...
class Grammar extends BaseGrammar
{
    ...
    public function parameter($value)
    {
        ...
        if (is_bool($value)) {
        ...
        } elseif (is_string($value) && is_array(json_decode($value, true)) && (json_last_error() == JSON_ERROR_NONE)) {
            return $value;
            ...
            if (preg_match('~#(-)?[0-9]+:[0-9]+~', $value)) {//is (graph) id, don't wrap it or error would be thrown
                return $value;
            }
